...
var cards  = {}
var cardsUpMax = 2
var animals = ['golden-retriever', 'pug', 'poodle', 'pomeranian-lulu', 'siberian-husky', 'dalmatian']
...
function reset(){
    ...
    cards = {}
    cardsUpMax = 2
    game.innerHTML = '<input type="button" value="Start" onclick="startHard()" class="button start" id="istart"><input type="button" value="Play Again" onclick="reset()"class="button playAgain" id="iPlayAgain">'
}