...
var cards  = {}
var cardsUpMax = 2
var animals = ['tiger', 'lion', 'jaguar', 'cheetah']
...
function reset(){
    ...
    cards = {}
    cardsUpMax = 2
    game.innerHTML = '<input type="button" value="Start" onclick="startMedium()" class="button start" id="istart"><input type="button" value="Play Again" onclick="reset()"class="button playAgain" id="iPlayAgain">'
}