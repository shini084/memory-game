...
function reset(){
    ...
    cards = {}
    cardsUpMax = 2
    game.innerHTML = '<input type="button" value="Start" onclick="startEasy()" class="button start" id="istart"><input type="button" value="Play Again" onclick="reset()"class="button playAgain" id="iPlayAgain">'
}